        ...
        <div class="dashboard-wrap">
            ...
            <?php
              ...
              ?>
                ...
                <form action="../../controllers/processTutorSupport.php" method="POST">
                            ...
                            <div class="inp-wrap sm">
                                ...
                                <select class="inp" name="lesson">
                                  ...
                                  <?php foreach ($bookedLessons as $booking) { 
                                      ...
                                      $lessonDetail = "{$booking['language']} lesson with {$booking['username']} on $formattedDate - Lesson ID: {$booking['id']}";
