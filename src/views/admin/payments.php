...
<html lang="en">
  <head>
    ...
    <title>MyLanguageTutor : Payments</title>
        ...
        <div class="dashboard-wrap">
            <div class="side-nav">
                <ul>
                    ...
                    <li><a class="active" href="payments"><i class="fa-regular fa-money-bill-1"></i> <span>Payments</span></a></li>
                ...
                <!-- <div class="searchTop">
                    <div class="searchTop-left">
                        <select class="inp" name="" id="">
                            ...
                            <option value="">Annaul Fee</option>
                        </select>
                    </div>
                    <div class="searchTop-right">
                        <div>
                            <input class="inp" type="text" placeholder="Order NO">
                        </div>
                    </div>
                </div> -->
        ...
        <table class="table theme-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="view-profile.php?username=<?= $payment['username'] ?>"><?= $payment['payment_type'] == 'subscription' ? 'Premium subscription' : 'Annual Access Fee' ?></a></td>
            ...
            <tfoot>
                <tr>
                    <td colspan="6">
                        <span>Showing <?= (($page - 1) * $limit) + 1 ?>-<?= min($page * $limit, $totalPayments) ?> of Total <?= $totalPayments ?></span>
                        <span class="table-nav">
                            <?php if ($page > 1): ?>
                            <a href="?page=<?= $page - 1 ?>"><i class="fa-solid fa-arrow-left"></i></a>
                            <?php endif; ?>
                            <span><?= $page ?></span>
                            <?php if ($page < ceil($totalPayments / $limit)): ?>
                            <a href="?page=<?= $page + 1 ?>"><i class="fa-solid fa-arrow-right"></i></a>
                            <?php endif; ?>
                        </span>
                    </td>
                </tr>
