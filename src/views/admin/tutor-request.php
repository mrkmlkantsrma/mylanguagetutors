            ...
            <div class="main-container">
                ...
                <div class="table-area extend mt-0">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">                        
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-1">New Requests</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-2">Unapproved</button>
                        </li>
                    </ul>
                            ...
                            <div class="table-responsive">
                                <table class="table theme-table">
                                    <thead>
                                        ...
                                        <th>PROFILE <span><img src="./assets/images/filter.png" alt=""></span></th>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($unapprovedTutors as $tutor): ?>
                                        <tr>
                                            <td><strong><?= $tutor['first_name'] . ' ' . $tutor['last_name'] ?> </strong> <br> <?= $tutor['email'] ?></td>
                                            <td><a href="tutor-profile.php?email=<?= $tutor['email'] ?>">View Profile</a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    <tfoot>
                                        <!-- You can add pagination or any other footer content here if required -->
                                    </tfoot>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show" id="tab-2">
                            <div class="table-responsive">
                                <table class="table theme-table">
                                    ...
                                    <tbody>
                                        <?php foreach ($requireTutorChanges as $tutor): ?>
                                        <tr>
                                            <td><strong><?= $tutor['first_name'] . ' ' . $tutor['last_name'] ?> </strong> <br> <?= $tutor['email'] ?></td>
                                            <td><a href="tutor-profile.php?email=<?= $tutor['email'] ?>">View Profile</a></td>
                                        </tr>
