...
<html lang="en">
  <head>
    ...
    <title>MyLanguageTutor : Quick Metrics</title>
  ...
  <div class="site-wrapper">
        ...
        <div class="dashboard-wrap">
            <div class="side-nav">
                <ul>
                    <li><a class="active" href="overview"><i class="fa-solid fa-chart-column"></i> <span>Overview</span></a></li>
                ...
                <div class="metrix">
                    <div class="row">
                        <div class="col-sm-6 col-lg-4">
                            <div class="metrix-single">
                                <div class="metrix-title">
                                    <div class="metrix-icon"><i class="fa-solid fa-users"></i></div>
                                    <div>
                                        <h2 class="title">Users</h2>
                                        <p>Past 30 days</p>
                                    </div>
                                </div>
                                <div class="metrix-top">
                                    <p>New users</p>
                                    <h2 class="title"><?php echo $thirtyDaysMetrics['users']['total']; ?></h2>
                                </div>
                                <div class="metrix-bottom">
                                    <div>
                                        <p>Students</p>
                                        <h2 class="title"><?php echo $thirtyDaysMetrics['users']['students']; ?></i></h2>
                                    </div>
                                    <div>
                                        <p>Tutors</p>
                                        <h2 class="title"><?php echo $thirtyDaysMetrics['users']['tutors']; ?> </h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <div class="metrix-single">
                                <div class="metrix-title">
                                    <div class="metrix-icon"><i class="fa-solid fa-money-bill-1-wave"></i></div>
                                    <div>
                                ...
                                <div class="metrix-top">
                                    <p>Total</p>
                                    <h2 class="title">$<?php echo $thirtyDaysMetrics['payments']['total']; ?> </h2>
                                </div>
                                <div class="metrix-bottom">
                                    <div>
                                        <p>Annual access fee</p>
                                        <h2 class="title">$<?php echo $thirtyDaysMetrics['payments']['annual_fee']; ?> </i></h2>
                                    </div>
                                    <div>
                                        <p>Subscription</p>
                                        <h2 class="title">$<?php echo $thirtyDaysMetrics['payments']['subscription']; ?> </h2>
                                    </div>
                                    <div>
                                        <p>Group Classes</p>
                                        <h2 class="title">$<?php echo $thirtyDaysMetrics['payments']['group_classes']; ?> </h2>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4">
                            <div class="metrix-single">
                                <div class="metrix-title">
                                    <div class="metrix-icon"><i class="fa-solid fa-receipt"></i></div>
                                    <div>
                                ...
                                <div class="metrix-top">
                                    <p>Total</p>
                                    <h2 class="title"><?php echo $thirtyDaysMetrics['bookings']['total']; ?> </i></h2>
                                </div>
                                <div class="metrix-bottom">
                                    <div>
                                        <p>Completed</p>
                                        <h2 class="title"><?php echo $thirtyDaysMetrics['bookings']['completed']; ?> </h2>
                                    </div>
                                    <div>
                                        <p>Cancelled</p>
                                        <h2 class="title"><?php echo $thirtyDaysMetrics['bookings']['cancelled']; ?> </i></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
